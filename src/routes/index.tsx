  ...
  return (
    <section id="join" className="relative overflow-hidden px-4 pt-20 pb-20 sm:px-6 sm:pt-24 sm:pb-28">
      ...
      <div className="relative mx-auto flex max-w-5xl flex-col items-center text-center">
        ...
        >
          <a href="https://community.zenher.in/" className="group inline-flex items-center justify-center gap-2 rounded-full bg-gradient-primary px-7 py-3.5 font-medium text-primary-foreground shadow-glow transition hover:scale-[1.02]">
